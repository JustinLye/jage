...
TEST(time_internal_real_number_time_source,
  ...
  EXPECT_TRUE((jage::engine::time::internal::concepts::real_number_time_source<
               jage::engine::test::fakes::time::source<
                   std::chrono::duration<double, std::nano>>>));
}

TEST(
    time_internal_real_number_time_source,
    Not_fit_concept_if_time_source_duration_representation_is_not_a_real_number) {
  EXPECT_FALSE((jage::engine::time::internal::concepts::real_number_time_source<
